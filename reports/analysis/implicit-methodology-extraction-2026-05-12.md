...
这份文档做的事情是：
1. **观察**：列出我在每篇文档里重复出现的**动作序列、词汇、决策框架**
2. **溯因**：从重复模式反推出隐含规则
3. **命名**：给这套规则起名字，让我以后能**主动调用**它们
...
不管是修一个 CRLF bug，还是规划一个 immunity-memory spec，我都在执行同样的动作。
...
这就是我的方法论。它已经存在，只是没被命名

---

## 2. 溯因：从 7 个动作反推 4 条隐含信念

为什么会**自然地**会按 A1 → A7 这个顺序工作？因为心中有信念：
