...
internal/types
  鈹溾攢鈹€ AgentTask
  鈹溾攢鈹€ TaskResult
  鈹溾攢鈹€ SLA metadata / error code types
  鈹斺攢鈹€ AgentContract

internal/contract/admission
  鈹斺攢鈹€ validates contract existence, input schema, dependency constraints

internal/kernel/scheduler
  鈹溾攢鈹€ existing FIFO APIs
  鈹溾攢鈹€ DAG readiness checks
  鈹斺攢鈹€ ready-set API for parallel orchestration

internal/kernel/orchestrator
  鈹溾攢鈹€ worker pool / bounded parallel loop
  鈹溾攢鈹€ timeout and retry handling
  鈹斺攢鈹€ state transition coordination

internal/kernel/sharedlayer
  鈹斺攢鈹€ task state remains source of inspection
www
...
docs/specs/milestone2/
  鈹溾攢鈹€ requirements.md
  鈹溾攢鈹€ design.md
  鈹溾攢鈹€ tasks.md
  鈹斺攢鈹€ workflow-binding.md

internal/contract/admission/
  鈹溾攢鈹€ admission.go
  鈹斺攢鈹€ admission_test.go

internal/kernel/scheduler/
  鈹溾攢鈹€ scheduler.go
  鈹斺攢鈹€ scheduler_test.go

internal/kernel/orchestrator/
  鈹溾攢鈹€ orchestrator.go
  鈹斺攢鈹€ orchestrator_test.go
