...
- [ ] AgentExecutor interface 定义
- [ ] MockAgentExecutor 实现（使用现有 ModelProvider）
- [ ] AgentRuntimeAdapter（支持外部 Agent CLI）
- [ ] Orchestrator 支持 agent executor 路由
...
- [ ] analyze-change-request contract
- [ ] implement-change contract
- [ ] run-validation contract
- [ ] update-docs contract
- [ ] review-result contract
- [ ] spawn-followup-tasks contract

### 2.4 Bootstrap Loop Integration
- [ ] BootstrapOrchestrator 支持自循环任务
- [ ] follow-up task generation
- [ ] AutonomyTransition 规则引擎
- [ ] 集成测试
