...
## 进行中任务
- [ ] Milestone 2 T6：实现 error code 基础
...
## 下一步行动
1. 从 T6 开始实现 error code 基础
2. 保持 M2 scope：error codes、CLI/docs acceptance
3. Markdown 风格问题单独走文档清理任务，不阻塞当前 M2 T6
